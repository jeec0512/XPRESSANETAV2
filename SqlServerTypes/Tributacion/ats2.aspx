<%@ Page Title="" Language="C#" MasterPageFile="~/Tributacion/mpTributacion.master" AutoEventWireup="true" CodeFile="ats2.aspx.cs" Inherits="Tributacion_ats2" EnableEventValidation="false" %>
            ...
            <asp:GridView ID="grvCabeceraAts" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="id_cabAts" HeaderText="	id_cabAts	 " Visible="false" />
                        ...
                        <asp:BoundField DataField="codCompraC" HeaderText="	codCompra	 " Visible="true" />
                        ...
                        <asp:BoundField DataField="codcompraD" HeaderText="codcompraD" Visible="true" />
                        ...
                        <asp:BoundField DataField="retImpRtaAsociado" HeaderText="retImpRtaAsociado" Visible="true"  DataFormatString="{0:N}"/>
                        <asp:BoundField DataField="anoUtilidadDividendo" HeaderText="anoUtilidadDividendo" Visible="true"  DataFormatString="{0:N}"/>
