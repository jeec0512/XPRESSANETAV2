    ...
    protected void listaReportes(string ltipo, string laccion1, string laccion2)
    {
        ...
        if (ltipo == "1")
        {
            if (tipo == 3 || tipo == 4)
            {
                laccion1 = "DETALLE";
                laccion2 = "TOTAL";
                grvSocios.DataSource = dc.sp_ventasxgrupos(laccion1, lsucursal, lfechaInicio, lfechaFin, grupo);
                grvSocios.DataBind();

                grvTotalSocios.DataSource = dc.sp_ventasxgruposTotal(laccion2, lsucursal, lfechaInicio, lfechaFin, grupo);
