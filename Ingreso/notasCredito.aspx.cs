...
public partial class Ingreso_notasCredito : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string facturacion = "http://192.168.1.118:8080/xpressweb/site/ncredito.an?prmusrid=" + userId;
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        //  sUrl = " http://www.aneta.org.ec:8084/expressweb/site/home.an?prmusrid=" + userId;
        sUrl = " http://192.168.1.118:8080/xpressweb/site/ncredito.an?prmusrid={*usuarios}";

        string facturacion = "http://www.aneta.org.ec:8084/expressweb/site/ncredito.an?prmusrid=" + userId;
