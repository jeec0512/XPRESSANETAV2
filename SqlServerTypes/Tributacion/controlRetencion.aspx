<%@ Page Title="" Language="C#" MasterPageFile="~/Tributacion/mpTributacion.master" AutoEventWireup="true"
    CodeFile="controlRetencion.aspx.cs" Inherits="Tributacion_controlRetencion" EnableEventValidation="false" %>
        ...
        <fieldset id="fdDetalleCaja" class="fieldset-principal">
            ...
            <asp:GridView ID="grvEgresosDetalle" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="CERO" HeaderText="CERO" Visible="true" DataFormatString="{0:N}" />
                    <asp:BoundField DataField="DIEZ" HeaderText="DIEZ" Visible="true" DataFormatString="{0:N}" />
                    <asp:BoundField DataField="VEINTE" HeaderText="VEINTE" Visible="true" DataFormatString="{0:N}" />
                    <asp:BoundField DataField="TREINTA" HeaderText="TREINTA" Visible="true" DataFormatString="{0:N}" />
                    <asp:BoundField DataField="SETENTA" HeaderText="SETENTA" Visible="true" DataFormatString="{0:N}" />
                    <asp:BoundField DataField="CIEN" HeaderText="CIEN" Visible="true" DataFormatString="{0:N}" />

                    <asp:BoundField DataField="fCERO" HeaderText="fCERO" Visible="true" DataFormatString="{0:N}" />
                    <asp:BoundField DataField="f303" HeaderText="f303" Visible="true" DataFormatString="{0:N}" />
                    <asp:BoundField DataField="f304" HeaderText="f304" Visible="true" DataFormatString="{0:N}" />
                    <asp:BoundField DataField="f307" HeaderText="f307" Visible="true" DataFormatString="{0:N}" />
                    <asp:BoundField DataField="f308" HeaderText="f308" Visible="true" DataFormatString="{0:N}" />
                    <asp:BoundField DataField="f309" HeaderText="f309" Visible="true" DataFormatString="{0:N}" />
                    <asp:BoundField DataField="f310" HeaderText="f310" Visible="true" DataFormatString="{0:N}" />
                    <asp:BoundField DataField="f312" HeaderText="f312" Visible="true" DataFormatString="{0:N}" />
                    <asp:BoundField DataField="f320" HeaderText="f320" Visible="true" DataFormatString="{0:N}" />
                    <asp:BoundField DataField="f322" HeaderText="f322" Visible="true" DataFormatString="{0:N}" />
                    <asp:BoundField DataField="f332" HeaderText="f332" Visible="true" DataFormatString="{0:N}" />
