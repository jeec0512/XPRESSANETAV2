<%@ Page Title="" Language="C#" MasterPageFile="~/Herramienta/mpHerramienta.master" AutoEventWireup="true" CodeFile="activarCajaEgresos.aspx.cs" Inherits="Herramienta_activarCajaEgresos" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" Runat="Server"><asp:ScriptManager runat="server" ID="sm1">
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            <legend>Activar cajas de egresos</legend>
        ...
        <asp:Button ID="btnEstadoSuc" runat="server" CssClass="btnProceso" Text="Estado de cierre de la sucursal" Visible="true" OnClick="btnEstadoSuc_Click" />
    </asp:Panel>
    ...
    <asp:Panel ID="pnEstadoSuc" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="Fieldset1" class="fieldset-principal">
            ...
            <asp:GridView ID="grvEstadoSuc" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" 
            BorderWidth="1px" CellPadding="1" GridLines="Vertical" HorizontalAlign="Center" Width="90%" AllowPaging="True" AllowSorting="True" 
            PageSize="50" OnSelectedIndexChanged="grvEstadoSuc_SelectedIndexChanged"  datakeynames ="id_CabEgresos">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Número" ItemStyle-Wrap="False">
                    <ItemTemplate>
                        <%# Eval("numero") %>
                    </ItemTemplate>
                </asp:TemplateField>
