...
public partial class Ingreso_facturacionElectronica : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lblMensaje.Text = Convert.ToString(userId) + "USUARIO";
            
            string facturacion = "http://192.168.1.118:8080/xpressweb/site/home.an?prmusrid=" + userId;
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        if (usuario == "" || usuario == null)
          ...
          sUrl = " http://192.168.1.118:8080/xpressweb/site/home.an?prmusrid=" + userId;
        sUrl = " http://192.168.1.118:8080/xpressweb/site/home.an?prmusrid={*usuarios}";

        string facturacion = "http://192.168.1.118:8080/xpweb/site/home.an?prmusrid=" + userId;
