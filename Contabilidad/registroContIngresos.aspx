<%@ Page Title="" Language="C#" MasterPageFile="~/Contabilidad/mpContabilidad.master" AutoEventWireup="true" CodeFile="registroContIngresos.aspx.cs" 
    Inherits="Contabilidad_registroContIngresos"    EnableEventValidation="false" %>
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            ...
            <asp:Panel ID="pnDatos" CssClass="pnPeq" runat="server" Visible="true">
                ...
                <div id="Div2" runat="server" style="margin: 2rem;">
                    ...
                    <asp:Button ID="btnIngresos" runat="server" CssClass="btnProceso" Text="Proceso registro contable de Ingresos" OnClick="btnIngresos_Click" Style="margin-bottom: 1rem; padding-top: 1rem;" />
