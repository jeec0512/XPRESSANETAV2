...
public partial class Egreso_controlAutoconsumo : System.Web.UI.Page
{
    ...
    protected void registrarDetalleEgresos()
    {
        ...
        */
        ...
        if (cDet.Count() <= 0)
        {
            ...
            dc.sp_abmAutoconsumoDetalle(lAccion, lid_DetEgresos, lid_CabEgresos, id_Concepto, lruc, lnombres, lid_documento, ldocumento, lnumAutorizacionRetencion, lautorizacion
    ...
    protected void btnConsultar_Click()
    {
        ...
        var cEgresos = dc.sp_ListarAutoconsumos(lAccion, lsucursal, lFechaIni, lFechaFin, "", 0);
