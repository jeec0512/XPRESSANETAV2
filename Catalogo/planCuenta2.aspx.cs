...
public partial class Catalogo_planCuenta2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string controlEstudiantil = "http://192.168.1.118:8080/xpressapp/admin/plancuentas.an?prmusrid=" + userId;
			https://anuiosrvfac04.aneta.org.ec/xpressapp/admin/plancuentas.an?prmusrid=1
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        sUrl = " http://192.168.1.118:8080/xpressapp/admin/plancuentas.an?prmusrid=" + userId;
