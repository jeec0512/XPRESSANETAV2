<%@ Page Title="" Language="C#" MasterPageFile="~/Contabilidad/mpContabilidad.master" AutoEventWireup="true" CodeFile="registroContablePedidoCheques.aspx.cs" 
    Inherits="Contabilidad_registroContablePedidoCheques"  EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" Runat="Server">
            ...
            <div id="Div3" runat="server" visible="true">
                ...
                <asp:Panel ID="pnCaja" runat="server" CssClass="pnFormDdl">
                    <asp:DropDownList ID="ddlCaja" runat="server">
                        ...
                        <asp:ListItem Value="K">k Pedido cheques</asp:ListItem>
                    </asp:DropDownList>
                </asp:Panel>
            </div>
        </fieldset>
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            <legend>Registro contable de pedido de cheques</legend>
            <asp:Panel ID="pnDatos" CssClass="pnPeq" runat="server" Visible="true">
                ...
                <div id="Div2" runat="server" style="margin: 2rem;">
                    ...
                    <asp:Button ID="btnIngresos" runat="server" CssClass="btnProceso" Text="Proceso registro contable de pedido de cheques" OnClick="btnIngresos_Click" Style="margin-bottom: 1rem; padding-top: 1rem;" />
                    <asp:Button ID="btnEgresos" runat="server" CssClass="btnProceso" Text="Proceso registro contable de Egresos" OnClick="btnEgresos_Click" Style="margin-bottom: 1rem; padding-top: 1rem" Visible="false" />
                    <asp:Button ID="btnAutoconsumos" runat="server" CssClass="btnProceso" Text="Proceso registro contable de Autoconsumos" Style="margin-bottom: 1rem; padding-top: 1rem" OnClick="btnAutoconsumos_Click" Visible="false" />
