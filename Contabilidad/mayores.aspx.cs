...
public partial class Contabilidad_mayores : System.Web.UI.Page
{
    ...
    protected void btnConsultar_Click()
    {
        ...
        //var cDocumentos = dw.pLibroMayorGeneral(year, periodo);

        var cDocumentos = dw.pBalanceComprobacion(year, periodo);
