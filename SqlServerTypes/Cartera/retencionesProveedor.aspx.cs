...
public partial class Cartera_retencionesProveedor : System.Web.UI.Page
{
    ...
    protected void grvProveedores_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (tipo == 4)
            {
                ...
                grvFacturasEmitidas.DataSource = dc.sp_buscaRetencionesProveedor(laccion, sucursal, lcedula);
