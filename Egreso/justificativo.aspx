<%@ Page Title="" Language="C#" MasterPageFile="~/Egreso/mpEgreso.master" AutoEventWireup="true" CodeFile="justificativo.aspx.cs"
    Inherits="Egreso_justificativo" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" runat="Server">
    ...
    <asp:Panel ID="pnMensaje2" CssClass="" runat="server" Visible="true">
        ...
        <asp:Button ID="btnIngresaProv" runat="server" Text="Ingrese el proveedor" Visible="false" OnClick="btnIngresaProv_Click" />
    </asp:Panel>
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="cabEgresos" class="fieldset-principal">
            ...
            <asp:Panel ID="Panel1" CssClass="pnPeq" runat="server" Visible="true">
                ...
                <asp:Label ID="lblFecha" runat="server" Text="Fecha:" CssClass="lblPeq"></asp:Label>
                <asp:TextBox runat="server" ID="txtFecha" CssClass="txtPeq"></asp:TextBox>
                ...
                <!--<asp:TextBox runat="server" ID="txtDocJustificado" placeHolder="R.U.C./C.C."></asp:TextBox>!-->

                <asp:DropDownList ID="ddlDocJustificar" runat="server" CssClass="peqDdl" DataTextField="descripcion"
                    DataValueField="ID_DETEGRESOS"
                    AutoPostBack="True">
                </asp:DropDownList>
        ...
        <fieldset id="registrar" class="fieldset-principal">
            ...
            <fieldset id="fsCaja" class="fieldset-principal">
                ...
                <asp:Panel ID="pnProveedor" CssClass="pnPeq" runat="server" Visible="true" GroupingText="" ForeColor="#1d92e9">
                    ...
                    <asp:TextBox ID="txtNombres" CssClass="txtPeq" runat="server" Enabled="false" placeHolder="Nombres"></asp:TextBox>
                </asp:Panel>
            ...
            <fieldset id="fsDatos" class="fieldset-principal">
                ...
                <asp:Panel ID="pnDescripcion" CssClass="pnPeq" runat="server" Visible="true" GroupingText="Descripción"
                    ...
                    <asp:TextBox ID="txtAutorizacion" CssClass="txtPeq" runat="server" placeHolder="Autorizado por"></asp:TextBox>
                    <!--<asp:Label ID="lblDescripcion" CssClass="lblPeq" runat="server" Text="Descrip/Justif."></asp:Label>!-->
                    <asp:TextBox ID="txtDescripcion" CssClass="txtPeq" runat="server" placeHolder="Descripción"></asp:TextBox>
                ...
                <asp:Panel ID="pnBienIva" CssClass="pnPeq" runat="server" Visible="true" GroupingText="Bienes" ForeColor="#1d92e9">
                    ...
                    <asp:TextBox ID="txtBien" CssClass="txtPeq" runat="server" Visible="TRUE" Enabled="true" placeHolder="Descripción del bien"></asp:TextBox>

                    <asp:Label ID="lblBsubtotal" CssClass="lblPeq" runat="server" Text="Total Bienes" Visible="true"></asp:Label>
                ...
                <asp:Panel ID="pnServicioIva" CssClass="pnPeq" runat="server" Visible="true" GroupingText="Servicios"
                    ...
                    <!--<asp:Label ID="lblServicio" CssClass="lblPeq" runat="server" Text="Descrip/Serv." Visible="true"></asp:Label>!-->
                    <asp:TextBox ID="txtServicio" CssClass="txtPeq" runat="server" Visible="TRUE" Enabled="true" placeHolder="Descripción del servicio"></asp:TextBox>
                    <asp:Label ID="lblSsubtotal" CssClass="lblPeq" runat="server" Text="Total servicios" Visible="true"></asp:Label>
                    <asp:TextBox ID="txtSsubtotal" CssClass="txtPeq" runat="server" Visible="TRUE" Enabled="true" AutoPostBack="True"
                ...
                <asp:Panel ID="pnTotales" CssClass="pnPeq" runat="server" Visible="true" GroupingText="Totales" ForeColor="#1d92e9">
                    ...
                    <asp:TextBox ID="txtNumretencion" CssClass="txtPeq" runat="server" placeHolder="# Retención"></asp:TextBox>
                    <asp:TextBox ID="txtNumAutorizacion" CssClass="txtPeq" runat="server" placeHolder="# de Aut./Retención"></asp:TextBox>
                    ...
                    <asp:Label ID="lblValorFactura" CssClass="lblPeq" runat="server" Text="Doc-Ret"></asp:Label>
