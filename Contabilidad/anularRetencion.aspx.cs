...
public partial class Contabilidad_anularRetencion : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string controlEstudiantil = "http://www.aneta.org.ec:7070/awaxp/retenciones/anularret/" + userId;
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        sUrl = "http://www.aneta.org.ec:7070/awaxp/retenciones/anularret/" + userId;
