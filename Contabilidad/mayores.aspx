<%@ Page Title="" Language="C#" MasterPageFile="~/Contabilidad/mpContabilidad.master" AutoEventWireup="true" CodeFile="mayores.aspx.cs"
     Inherits="Contabilidad_mayores"    EnableEventValidation="false" %>
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            ...
            <asp:Panel ID="pnDatos" runat="server" Visible="true" Style="display: flex;">
                ...
                <div style="margin-left: 2rem;">
                    <asp:Button ID="btnConsultar" runat="server" CssClass="btnProceso" Text="Consultar General" OnClick="btnConsultar_Click" />
                </div>
            </asp:Panel>
        </fieldset>
    </asp:Panel>
