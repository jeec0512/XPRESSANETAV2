...
public partial class Herramienta_sriNotasCredito : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string facturacion = "http://www.aneta.org.ec:8084/portal/ncredito?prmusrid=" + userId; 
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        sUrl = "http://www.aneta.org.ec:8084/portal/ncredito?prmusrid=" + userId; ;
