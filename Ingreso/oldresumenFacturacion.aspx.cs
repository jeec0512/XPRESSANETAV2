...
public partial class Ingreso_resumenFacturacion : System.Web.UI.Page
{
    ...
    protected void btnFacturasEmitidas_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            lfechaInicio = Convert.ToDateTime(txtFechaIni.Text);
            lfechaFin = Convert.ToDateTime(txtFechaFin.Text);
            grvFacturasEmitidas.DataSource = dc.sp_FacturasEmitidas2(laccion, lsucursal, lfechaInicio, lfechaFin);
    ...
    protected void FacturasEmitidas_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if ((e.Row.RowType == DataControlRowType.DataRow) && (e.Row.RowType != DataControlRowType.EmptyDataRow))
        {
            ...
            baseimponible += Convert.ToDecimal(e.Row.Cells[8].Text);
            iva0 += Convert.ToDecimal(e.Row.Cells[9].Text);
            iva12 += Convert.ToDecimal(e.Row.Cells[10].Text);
            cxp += Convert.ToDecimal(e.Row.Cells[11].Text);
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[8].Text = Convert.ToString(baseimponible);
            e.Row.Cells[9].Text = Convert.ToString(iva0);
            e.Row.Cells[10].Text = Convert.ToString(iva12);
            e.Row.Cells[11].Text = Convert.ToString(cxp);
            e.Row.Cells[12].Text = Convert.ToString(Total);
        }
    }
    #endregion
