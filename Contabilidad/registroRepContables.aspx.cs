...
public partial class Contabilidad_registroRepContables : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string facturacion = " http://www.aneta.org.ec:7070/awaxp/" + userId;
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        sUrl = " http://181.188.214.60:8084/awa/1";

        string facturacion = "http://www.aneta.org.ec:7070/awaxp/1";
