<%@ Page Title="" Language="C#" MasterPageFile="~/EgresosANETAExpress/mpEgresosANETAExpress.master" AutoEventWireup="true" CodeFile="preContabilizacionEgresosPK.aspx.cs"
     Inherits="EgresosANETAExpress_preContabilizacionEgresosPK"    EnableEventValidation="false" %>
        ...
        <fieldset id="Fieldset1" class="fieldset-principal">
            ...
            <asp:GridView ID="grvContabilizacion" runat="server" AutoGenerateColumns="False" BackColor="White"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="DEBITO" HeaderText="Debe" Visible="TRUE" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N}"/>
                    <asp:BoundField DataField="CREDITO" HeaderText="Haber" Visible="TRUE" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:N}" />
