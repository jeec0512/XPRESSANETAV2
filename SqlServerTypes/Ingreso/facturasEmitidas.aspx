    ...
    <asp:Panel ID="pnListado" runat="server" CssClass="" Visible="true">
        <fieldset id="fsListado" class="fieldset-principal">
            ...
            <asp:GridView ID="grvListadoFac" runat="server" AutoGenerateColumns="False" BackColor="White"
                ...
                AllowSorting="True" PageSize="100" OnPageIndexChanged="grvListadoFac_PageIndexChanged" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="S.R.I." FooterStyle-Wrap="False">
                        <ItemTemplate>
                            <%# Eval("FAC_SRI") %>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Vendedor" FooterStyle-Wrap="False">
                        <ItemTemplate>
                            <%# Eval("FAC_VENDEDOR") %>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Observación" FooterStyle-Wrap="False">
                        <ItemTemplate>
                            <%# Eval("FAC_OBSERVACION") %>
                        </ItemTemplate>
                    </asp:TemplateField>
