...
public partial class Contabilidad_registroContEgresos : System.Web.UI.Page
{
    ...
    protected void btnAutoconsumos_Click(object sender, EventArgs e)
    {
        ...
        //var cDocumentos = dw.pBatchContabilizacionAutoconsumos(lFechaIni, lFechaFin, sucursal, lusuario,ref numero, ref referencia);


        //var cDocumentos = 
            dw.pBatchContabilizacionAutoconsumos(lFechaIni, lFechaFin, sucursal, lusuario,true, ref numero, ref referencia);
    ...
    protected void btnIngresos_Click()
    {
        ...
        //var cDocumentos = dw.pBatchContabilizacionVentas(lFechaIni, lFechaFin, sucursal, lusuario, ref numero, ref referencia);
        //var cDocumentos = 
            dw.pBatchContabilizacionVentas(lFechaIni, lFechaFin, sucursal, lusuario, true, ref numero, ref referencia);
    ...
    protected void btnEgresos_Click(object sender, EventArgs e)
    {
        ...
        //var cDocumentos = 
            dw.pBatchContabilizacionEgresos(lFechaIni, lFechaFin, sucursal, lusuario,caja,true,ref numero, ref referencia);
