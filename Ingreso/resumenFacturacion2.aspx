<%@ Page Title="" Language="C#" MasterPageFile="~/Ingreso/mpIngreso.master" AutoEventWireup="true" CodeFile="resumenFacturacion2.aspx.cs" Inherits="Ingreso_resumenFacturacion2"  EnableEventValidation="false" %>
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            ...
            <asp:Panel ID="Panel3" CssClass="pnAccionGrid" runat="server" Wrap="False">
                ...
                <asp:Button ID="btnContabilizacion" runat="server" CssClass="btnProceso" Text="Vista del Asiento Contable" Visible="true"
                    OnClick="btnContabilizacion_Click" />
                <asp:Button ID="btnImprimir" runat="server" CssClass="btnProceso" Text="Imprimir asiento contable" OnClick="btnImprimir_Click" />
            </asp:Panel>
        </fieldset>
    </asp:Panel>
        ...
        <fieldset id="fsContabilizacion" class="fieldset-principal">
            ...
            <asp:GridView ID="grvContabilizacion" runat="server" AutoGenerateColumns="False" BackColor="White"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="CodTercero" HeaderText="Tercero" Visible="TRUE" />
                </Columns>
                <FooterStyle BackColor="#CCCCCC" ForeColor="Black" />
                <HeaderStyle BackColor="#0C80BF" Font-Bold="True" ForeColor="White" />
                <PagerStyle BackColor="#999999" ForeColor="black" HorizontalAlign="Center" />
