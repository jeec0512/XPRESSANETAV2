<%@ Page Title="" Language="C#" MasterPageFile="~/Egreso/mpEgreso.master" AutoEventWireup="true" CodeFile="cierreAutoconsumos.aspx.cs" Inherits="Egreso_cierreAutoconsumos"  EnableEventValidation="false" %>
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            ...
            <asp:Panel ID="pnDatos" CssClass="pnPeq" runat="server" Visible="true">
                ...
                <asp:Button ID="btnImprimir" runat="server" CssClass="btnProceso"  Text="Imprimir" OnClick="btnImprimir_Click" />
