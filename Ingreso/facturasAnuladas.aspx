<%@ Page Title="" Language="C#" MasterPageFile="~/Ingreso/mpIngreso.master" AutoEventWireup="true" CodeFile="facturasAnuladas.aspx.cs"
    Inherits="Ingreso_facturasAnuladas" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" runat="Server">
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            <legend>Facturas anuladas</legend>
            ...
            <asp:Panel ID="Panel3" CssClass="pnAccionGrid" runat="server" Wrap="False">
                <asp:Button ID="btnAnuTotal" runat="server" CssClass="btnProceso" Text="Facturas anuladas ANETA" Visible="true"
                    OnClick="btnAnuTotal_Click" />
                <asp:Button ID="btnAnuxSuc" runat="server" CssClass="btnProceso" Text="Facturas anuladas por sucursal"
                    OnClick="btnAnuxSuc_Click" />
            </asp:Panel>
        </fieldset>
    </asp:Panel>

    <asp:Panel ID="pnTotalAnuladas" CssClass="" runat="server" Visible="true">
        <fieldset id="Fieldset2" class="fieldset-principal">
            <legend>Facturas anuladas</legend>
            <asp:Button ID="btnExcelAS" runat="server" CssClass="btnLargoForm " Text="A Excel total" Visible="true" OnClick="btnExcelAS_Click"  />
            <asp:GridView ID="grvTotalAnuladas" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999"
    ...
    <asp:Panel ID="pnAnuladas" CssClass="" runat="server" Visible="true">

        <fieldset id="Fieldset1" class="fieldset-principal">
            <legend>Facturas anuladas</legend>
            <asp:Button ID="btnExcelAA" runat="server" CssClass="btnLargoForm " Text="A Excel detalle" Visible="true" OnClick="btnExcelAA_Click"  />
            <asp:GridView ID="grvAnuladas" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999"
                BorderStyle="None" BorderWidth="1px" CellPadding="5" GridLines="Vertical"
                HorizontalAlign="Center" Width="95%" AllowPaging="false" AllowSorting="True" PageSize="50">
                <AlternatingRowStyle BackColor="#DCDCDC" />
                <Columns>
