...
public partial class Herramienta_cajaEgreso : System.Web.UI.Page
{
    ...
    private void cargaGridTodos()
    {
         ...
         try
        {
            ...
            grvListadoFac.DataSource = dc.sp_ctrlCierresEgresosxSuc2(laccion, ltipoSuc, lsucursal, lfechaInicio, lfechaFin); 
    ...
    protected void btnConsolidado_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (tipo == 4)
            {
                grvConsolidado.DataSource = dc.sp_cajasEgresos("TODOS", lsucursal, lfechainicio, lfechafin);
            ...
            {
                grvConsolidado.DataSource = dc.sp_cajasEgresos("XSUC", lsucursal, lfechainicio, lfechafin);
                grvConsolidado.DataBind();
            }
    ...
    protected void grvConsolidado_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (e.Row.Cells[5].Text.CompareTo("1") == 0)
            {
                //e.Row.Cells[5].CssClass = "Rojo";
                e.Row.CssClass = "Rojo";
            }
            else if (e.Row.Cells[5].Text.CompareTo("3") == 0)
            {
