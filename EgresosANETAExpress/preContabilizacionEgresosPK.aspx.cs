...
public partial class EgresosANETAExpress_preContabilizacionEgresosPK : System.Web.UI.Page
{
    /************VARIABLES GENERALES***********************/
    decimal cantidad = 0;
    ...
    protected void btnAsiento_Click(object sender, EventArgs e)
    {
        ...
        grvContabilizacion.DataSource = dc.pConsultarEgresosKP(lfechaInicio, lfechaFin, lsucursal, ref numero, ref referencia);
