...
public partial class Ingreso_imprimirAsientoIngresos : System.Web.UI.Page
{
    ...
    protected void cierreCaja()
    {
        ...
        string lsuc, lsucursal;
        int usuario;

        usuario = Convert.ToInt32(Session["UsuarioID"]);
        ...
        var cEgresos = dc.pConsultarIngresos(lFechaInicio, lFechaFin, lsucursal, usuario, ref codigoproceso, ref mensaje);
