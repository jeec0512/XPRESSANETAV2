<%@ Page Title="" Language="C#" MasterPageFile="~/Egreso/mpEgreso.master" AutoEventWireup="true" CodeFile="autoConsumo.aspx.cs" Inherits="Egreso_autoConsumo" EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" Runat="Server">
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="cabEgresos" class="fieldset-principal">
            <legend>Registro de autoconsumos</legend>

            <asp:Panel ID="Panel1" CssClass="pnBtnProcesos" runat="server" Visible="true">
    ...
    <!-- LISTADO DE PAGOS!-->
    <asp:Panel ID="pnDetallePagos" runat="server" CssClass="" Visible="false">
        <fieldset id="listados" class="fieldset-principal">
            ...
            <asp:GridView ID="grvDetallePagos" runat="server"
                ...
                AllowSorting="True"
                PageSize="50"
                DataKeyNames="id_DetEgresos" OnSelectedIndexChanged="grvDetallePagos_SelectedIndexChanged" 
                OnPageIndexChanging="grvDetallePagos_PageIndexChanging" 
                OnSelectedIndexChanging="grvDetallePagos_SelectedIndexChanging">
            ...
            <asp:Panel ID="pnMenu" CssClass="pnFormHijo" runat="server" Visible="true">
                ...
                <asp:Button ID="btnNuevoRegistro" runat="server" CssClass="btnProceso" Text="Nuevo Registro" Visible="true"  />!-->
    ...
    <asp:Panel ID="pnPagos" runat="server" CssClass="" Visible="false">
        <fieldset id="registrar" class="fieldset-principal">
            <legend>Registrar Autoconsumoo</legend>
