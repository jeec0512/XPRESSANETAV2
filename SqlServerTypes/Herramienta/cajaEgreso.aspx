<%@ Page Title="" Language="C#" MasterPageFile="~/Herramienta/mpHerramienta.master" AutoEventWireup="true" CodeFile="cajaEgreso.aspx.cs" Inherits="Herramienta_cajaEgreso" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" Runat="Server">
    ...
    <asp:Panel ID="pnTitulos" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="fdTitulos" class="fieldset-principal">
            <legend>Control de cajas de egresos</legend>
    ...
    <asp:Panel ID="pnListado" runat="server" CssClass="" Visible="true">
        <fieldset id="fsListado" class="fieldset-principal">
            <legend>Listado de las cajas de egreso y su estado</legend>
            ...
            <asp:GridView ID="grvListadoFac" runat="server"  Width="90%"  HorizontalAlign="Center" BorderStyle="None" 
               ...
               >
                ...
                <Columns>
                     ...
                     <asp:BoundField DataField="numero" HeaderText="Caja" SortExpression="sucursal" />
                     <asp:BoundField DataField="estado" HeaderText="Estado" SortExpression="sucursal" ItemStyle-CssClass="DisplayNone" HeaderStyle-CssClass="DisplayNone"/>
            </Columns>
    ...
    <asp:Panel ID="pnConsolidado" runat="server" CssClass="" Visible="true">
        <fieldset id="fsConsolidado" class="fieldset-principal">
            ...
            <asp:GridView ID="grvConsolidado" runat="server" 
                ...
                <Columns>
                    <asp:BoundField DataField="sucursal" HeaderText="Código" SortExpression="sucursal" />
                    <asp:BoundField DataField="nom_suc" HeaderText="Nombre" SortExpression="nom_suc" />
                    <asp:BoundField DataField="verde" HeaderText="#CajasCerradas" ReadOnly="True" SortExpression="verde" />
                    <asp:BoundField DataField="rojo" HeaderText="#CajasAbiertas" ReadOnly="True" SortExpression="rojo" />
                    <asp:BoundField DataField="numcajas" HeaderText="Total" ReadOnly="True" 
                        SortExpression="numcajas" />
                    <asp:BoundField DataField="pasa" HeaderText="Estado" ReadOnly="True" SortExpression="pasa"   ItemStyle-CssClass="DisplayNone" HeaderStyle-CssClass="DisplayNone"/>
                </Columns>
                 <HeaderStyle BackColor="#0C80BF" Font-Bold="True" ForeColor="White" />
            </asp:GridView>
