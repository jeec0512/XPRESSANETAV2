<%@ Page Title="" Language="C#" MasterPageFile="~/Egreso/mpEgreso.master" AutoEventWireup="true" CodeFile="controlAutoconsumo2.aspx.cs"
    Inherits="Egreso_controlAutoconsumo2" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" runat="Server">
        ...
        <fieldset id="fdDetalleCaja" class="fieldset-principal">
            ...
            <asp:GridView ID="grvEgresosDetalle" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="rvar_gen" HeaderText="rvar_gen" Visible="true" />
                    <asp:BoundField DataField="rmae_gas" HeaderText="rmae_gas" Visible="true" />
    ...
    <asp:Panel ID="pnPagos" runat="server" CssClass="" Visible="false">
        <fieldset id="registrar" class="fieldset-principal">
            <legend>Registrar Autoconsumo</legend>
            ...
            <fieldset id="fsCaja" class="fieldset-principal">
                ...
                <asp:Panel ID="pnBienes" CssClass="pnPeq" runat="server" Visible="true" GroupingText="" ForeColor="#1d92e9">
                    ...
                    <asp:Panel ID="pnTipoDoc" runat="server" CssClass="pnPeqDdl">
                        <asp:DropDownList ID="ddlTipoDocumento" runat="server" CssClass="peqDdl" DataTextField="descripcion"
                            DataValueField="id"
                            AutoPostBack="True" OnSelectedIndexChanged="ddlTipoDocumento_SelectedIndexChanged" Enabled="false">
                        </asp:DropDownList>
                    </asp:Panel>
                </asp:Panel>
                ...
                <asp:Panel ID="pnProveedor" CssClass="pnPeq" runat="server" Visible="true" GroupingText="" ForeColor="#1d92e9">
                    ...
                    <asp:Panel ID="pnColaborador" runat="server" CssClass="pnPeqDdl" Visible="false">
                    ...
                    <asp:TextBox ID="txtRuc" CssClass="txtPeq" runat="server" AutoPostBack="True"
                        OnTextChanged="txtRuc_TextChanged" placeHolder="R.U.C./C.C." Enabled="false"></asp:TextBox>
                ...
                <asp:Panel ID="pnDocumento" CssClass="pnPeq" runat="server" Visible="true" GroupingText="" ForeColor="#1d92e9">
                    ...
                    <asp:TextBox ID="txtSerie" CssClass="txtPeq" runat="server" AutoPostBack="True" placeHolder="Serie" Visible="false"></asp:TextBox>
                    ...
                    <asp:TextBox ID="txtNumDocumento" CssClass="txtPeq" runat="server" AutoPostBack="True" OnTextChanged="txtNumDocumento_TextChanged"
                        placeHolder="#/Doc." Visible="false"></asp:TextBox>

                    <!--<asp:Label ID="lblDocRet" CssClass="lblPeq" runat="server" Text="#/Doc"></asp:Label>!-->
                    <asp:Panel ID="pnDocRet" runat="server" CssClass="pnPeqDdl" Visible="false">
                    ...
                    <act1:CalendarExtender ID="CalendarExtender2" PopupButtonID="" runat="server" TargetControlID="txtFechaEmisionDoc" Format="dd/MM/yyyy"></act1:CalendarExtender>
                    ...
                    <act1:CalendarExtender ID="CalendarExtender3" PopupButtonID="" runat="server" TargetControlID="txtFechaCaducDoc" Format="dd/MM/yyyy"></act1:CalendarExtender>
            ...
            <fieldset id="fsDatos" class="fieldset-principal">
                ...
                <asp:Panel ID="pnBienIva" CssClass="pnPeq" runat="server" Visible="true" GroupingText="Bienes(Y/O)lubricantes" ForeColor="#1d92e9">
                ...
                <asp:Panel ID="pnRepuestos" CssClass="pnPeq" runat="server" Visible="true" GroupingText="Repuestos" ForeColor="#1d92e9">
                    <asp:UpdatePanel ID="upRepuestos" runat="server">

                        <ContentTemplate>
                            <asp:Panel ID="pnBrGastos" runat="server" CssClass="pnPeqDdl">
                                <asp:DropDownList ID="ddlBrGastos" CssClass="peqDdl" DataTextField="nombre" DataValueField="mae_gas"
                                    runat="server" AutoPostBack="True">
                                </asp:DropDownList>
                            </asp:Panel>


                            <asp:Panel ID="pnBrCodCble" runat="server" CssClass="pnPeqDdl">
                                <asp:DropDownList ID="ddlBrCodCble" CssClass="peqDdl" DataTextField="nom_ic" DataValueField="var_gen"
                                    runat="server" AutoPostBack="True">
                                </asp:DropDownList>
                            </asp:Panel>
                        </ContentTemplate>
                    ...
                    <asp:TextBox ID="txtRepuesto" CssClass="txtTitPeq" runat="server" Visible="TRUE" Enabled="true" placeHolder="Descripción del repuesto"></asp:TextBox>


                    <asp:Label ID="lblRsubtotal" CssClass="lblPeq" runat="server" Text="Subtotal" Visible="true"></asp:Label>
                    <asp:TextBox ID="txtRsubtotal" CssClass="txtPeq" runat="server" Visible="TRUE" Enabled="true"
                        AutoPostBack="True" OnTextChanged="txtRsubtotal_TextChanged"></asp:TextBox>

                    <asp:Label ID="lblRtarifa0" CssClass="lblPeq" runat="server" Text="Tarifa 0" Visible="true"></asp:Label>
                    <asp:TextBox ID="txtRtarifa0" CssClass="txtPeq" runat="server" Visible="TRUE" Enabled="true"
                        AutoPostBack="True" OnTextChanged="txtRsubtotal_TextChanged"></asp:TextBox>

                    <asp:Label ID="lblRotros" CssClass="lblPeq" runat="server" Text="Otros" Visible="true"></asp:Label>
                    <asp:TextBox ID="txtRotros" CssClass="txtPeq" runat="server" Visible="TRUE" Enabled="true"
                        AutoPostBack="True" OnTextChanged="txtRsubtotal_TextChanged"></asp:TextBox>

                    <asp:Label ID="lblRIva" CssClass="lblPeq" runat="server" Text="I.V.A." Visible="true"></asp:Label>
                    <asp:TextBox ID="txtRIva" CssClass="txtPeq" runat="server" Visible="TRUE" Enabled="false"></asp:TextBox>


                    <asp:Label ID="lblRtotal" CssClass="lblPeq" runat="server" Text="Total Bienes" Visible="true"></asp:Label>
                    <asp:TextBox ID="txtRtotal" CssClass="txtPeq" runat="server" Visible="TRUE" Enabled="false"></asp:TextBox>
