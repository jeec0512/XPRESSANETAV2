...
public partial class Contabilidad_anulaCheques : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string anulaCheques = "http://192.168.1.118:8080/xpressapp/account/cancelcheck.an?prmusrid=" + userId;
            ...
            ifControlEst.Attributes["src"] = anulaCheques;
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        sUrl = " http://192.168.1.118:8080/xpressapp/account/cancelcheck.an?prmusrid=" + userId;
