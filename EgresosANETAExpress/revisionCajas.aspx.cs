...
public partial class EgresosANETAExpress_revisionCajas : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string controlEstudiantil = "http://192.168.1.118:8080/xpressapp/admin/caja.an?prmusrid=" + userId;
    ...
    protected void btnNotas_Click(object sender, EventArgs e)
    {
        ...
        sUrl = " http://192.168.1.118:8080/xpressapp/admin/caja.an?prmusrid=" + userId;
