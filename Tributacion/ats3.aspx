<%@ Page Title="" Language="C#" MasterPageFile="~/Tributacion/mpTributacion.master" AutoEventWireup="true"
    CodeFile="ats3.aspx.cs" Inherits="Tributacion_ats3" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoPrincipal" runat="Server">
    ...
    <asp:Panel ID="pnCabeceraAts" CssClass="" runat="server" Visible="true">
        ...
        <fieldset id="fdCabeceraAts" class="fieldset-principal">
            ...
            <asp:GridView ID="grvCabeceraAts" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999"
                ...
                <Columns>
                    <asp:BoundField DataField="id_cabAts" HeaderText="id_cabAts" Visible="true" />
                    ...
                    <asp:BoundField DataField="ano" HeaderText="ano" Visible="true" />
                    ...
                    <asp:BoundField DataField="numIdentProvee" HeaderText="numIdentProvee" Visible="true" />
                    ...
                    <asp:BoundField DataField="fechaRegistro" HeaderText="fechaRegistro" Visible="true" />
                    ...
                    <asp:BoundField DataField="fechaEmision" HeaderText="fechaEmision" Visible="true" />
                    <asp:BoundField DataField="numAutorizacion" HeaderText="numAutorizacion" Visible="true" />
                    <asp:BoundField DataField="biNOobjIva" HeaderText="biNOobjIva" Visible="true" />
                    <asp:BoundField DataField="biTarifaCero" HeaderText="biTarifaCero" Visible="true" />
                    <asp:BoundField DataField="biGravada" HeaderText="biGravada" Visible="true" />
                    <asp:BoundField DataField="bExenta" HeaderText="bExenta" Visible="true" />
                    <asp:BoundField DataField="montoIce" HeaderText="montoIce" Visible="true" />
                    <asp:BoundField DataField="montoIva" HeaderText="montoIva" Visible="true" />
                    <asp:BoundField DataField="retIvaBienes10" HeaderText="retIvaBienes10" Visible="true" />
                    <asp:BoundField DataField="retIvaServicios20" HeaderText="retIvaServicios20" Visible="true" />
                    <asp:BoundField DataField="retIvaBienes30" HeaderText="retIvaBienes30" Visible="true" />
                    <asp:BoundField DataField="retIvaBienes50" HeaderText="retIvaBienes50" Visible="true" />
                    <asp:BoundField DataField="retIvaServicios70" HeaderText="retIvaServicios70" Visible="true" />
                    <asp:BoundField DataField="retIvaServicios100" HeaderText="retIvaServicios100" Visible="true" />
                    <asp:BoundField DataField="totalBi" HeaderText="totalBi" Visible="true" />
                    ...
                    <asp:BoundField DataField="retFechaEmision" HeaderText="retFechaEmision" Visible="true" />
                    ...
                    <asp:BoundField DataField="retencion" HeaderText="retencion" Visible="true" />
                    <asp:BoundField DataField="retCodigo" HeaderText="retCodigo" Visible="true" />
                    <asp:BoundField DataField="retBase" HeaderText="retBase" Visible="true" />
                    <asp:BoundField DataField="retPorcentaje" HeaderText="retPorcentaje" Visible="true" />
                    <asp:BoundField DataField="retValor" HeaderText="retValor" Visible="true" />
                    <asp:BoundField DataField="retCodigo2" HeaderText="retCodigo2" Visible="true" />
                    <asp:BoundField DataField="retBase2" HeaderText="retBase2" Visible="true" />
                    <asp:BoundField DataField="retPorcentaje2" HeaderText="retPorcentaje2" Visible="true" />
                    <asp:BoundField DataField="retValor2" HeaderText="retValor2" Visible="true" />
                    <asp:BoundField DataField="retCodigo3" HeaderText="retCodigo3" Visible="true" />
                    <asp:BoundField DataField="retBase3" HeaderText="retBase3" Visible="true" />
                    <asp:BoundField DataField="retPorcentaje3" HeaderText="retPorcentaje3" Visible="true" />
                    <asp:BoundField DataField="retValor3" HeaderText="retValor3" Visible="true" />
                    <asp:BoundField DataField="retFechaDividendo" HeaderText="retFechaDividendo" Visible="true" />
                    <asp:BoundField DataField="retImpRtaAsociado" HeaderText="retImpRtaAsociado" Visible="true" />
                    <asp:BoundField DataField="anoUtilidadDividendo" HeaderText="anoUtilidadDividendo" Visible="true" />
    ...
    <!-- detalleATS  !-->
    <asp:Panel ID="pnDetalleATS" CssClass="" runat="server" Visible="false">
        ...
        <fieldset id="fsDetalleATS" class="fieldset-principal">
            ...
            <asp:GridView ID="grvDetalleATS" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="retCodigo" HeaderText="	retCodigo	 " Visible="true" />
                    <asp:BoundField DataField="retBase" HeaderText="	retBase	 " Visible="true" DataFormatString="{0:N}"
                        ItemStyle-HorizontalAlign="Right" />
                    <asp:BoundField DataField="retPorcentaje" HeaderText="	retPorcentaje	 " Visible="true" DataFormatString="{0:N}"
                        ItemStyle-HorizontalAlign="Right" />
                    <asp:BoundField DataField="retValor" HeaderText="	retValor	 " Visible="true" DataFormatString="{0:N}"
                        ItemStyle-HorizontalAlign="Right" />
                    <asp:BoundField DataField="retFechaDividendo" HeaderText="	retFechaDividendo	 " Visible="true"
