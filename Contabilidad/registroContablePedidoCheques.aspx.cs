...
public partial class Contabilidad_registroContablePedidoCheques : System.Web.UI.Page
{
    ...
    protected void btnAutoconsumos_Click(object sender, EventArgs e)
    {
        ...
        var cDocumentos = dw.pBatchContabilizacionAutoconsumos(lFechaIni, lFechaFin, sucursal, lusuario, false, ref numero, ref referencia);
    ...
    protected void btnIngresos_Click()
    {
        ...
        var cDocumentos = dw.pBatchContabilizacionEgresosKP(lFechaIni, lFechaFin, sucursal, lusuario, true, ref numero, ref referencia);

        lblMensaje.Text = "El registro contable de pedido de cheques se ha generado correctamente.";
    ...
    protected void btnEgresos_Click(object sender, EventArgs e)
    {
        ...
        var cDocumentos = dw.pBatchContabilizacionEgresos(lFechaIni, lFechaFin, sucursal, lusuario, caja, true, ref numero, ref referencia);
